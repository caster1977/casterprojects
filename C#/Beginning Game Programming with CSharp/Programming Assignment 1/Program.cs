...
{
    /// <summary>
    /// Application that will calculate the maximum height of the shell and the distance it will travel
    /// along the ground
    /// </summary>
    class Program
    {
        /// <summary>
        /// Class that will calculate the maximum height of the shell and the distance it will 
        /// travel along the ground
        /// </summary>
        /// <param name="args">Comand line args</param>
        static void Main(string[] args)
        {
            Console.WriteLine("This application will calculate the maximum height of the shell and the distance it" +
            ...
            theta = (float)(theta * Math.PI / 180); // conversion from degrees to radians
            ...
            float dx = vox * 2 * t; // distance shell travels horizontally 
                                    //(assuming launch and target elevations are equal)

            Console.WriteLine("Height of shell at apex: " + h.ToString("F3", CultureInfo.CurrentCulture));
            Console.WriteLine("Distance shell travels horizontally (assuming launch and target elevations are " +
              "equal: " + dx.ToString("F3", CultureInfo.CurrentCulture));
            Console.WriteLine();
        }
    }
}
