...
DROP TABLE IF EXISTS irda.irda_200806_normalized;
CREATE TABLE irda.irda_200806_normalized (KEY datum (datum), KEY ddi (ddi), KEY ani (ani)) SELECT * FROM irda.irda_200806;
...
UPDATE irda.irda_200806_normalized SET ddi='109' WHERE (LEFT(ddi,3)='109');
UPDATE irda.irda_200806_normalized SET ddi='130' WHERE (LEFT(ddi,3)='130');
UPDATE irda.irda_200806_normalized SET ddi='175' WHERE (LEFT(ddi,3)='175');
UPDATE irda.irda_200806_normalized SET ddi='188' WHERE (LEFT(ddi,3)='188');
UPDATE irda.irda_200806_normalized SET ddi='190' WHERE (LEFT(ddi,3)='190');
UPDATE irda.irda_200806_normalized SET ddi='191' WHERE (LEFT(ddi,3)='191');
UPDATE irda.irda_200806_normalized SET ddi='192' WHERE (LEFT(ddi,3)='192');
UPDATE irda.irda_200806_normalized SET ddi='193' WHERE (LEFT(ddi,3)='193');
UPDATE irda.irda_200806_normalized SET ddi='194' WHERE (LEFT(ddi,3)='194');
UPDATE irda.irda_200806_normalized SET ddi='195' WHERE (LEFT(ddi,3)='195');
UPDATE irda.irda_200806_normalized SET ddi='196' WHERE (LEFT(ddi,3)='196');
UPDATE irda.irda_200806_normalized SET ddi='197' WHERE (LEFT(ddi,3)='197');
UPDATE irda.irda_200806_normalized SET ddi='198' WHERE (LEFT(ddi,3)='198');
UPDATE irda.irda_200806_normalized SET ddi='199' WHERE (LEFT(ddi,4)='1111');
UPDATE irda.irda_200806_normalized SET ddi='9910911' WHERE (LEFT(ddi,4)='2222') OR (LEFT(ddi,7)='9910911');
UPDATE irda.irda_200806_normalized SET ddi='9919911' WHERE (LEFT(ddi,7)='9919911');
UPDATE irda.irda_200806_normalized SET ddi='99175' WHERE (LEFT(ddi,5)='99175');
UPDATE irda.irda_200806_normalized SET ddi='99188' WHERE (LEFT(ddi,5)='99188');
UPDATE irda.irda_200806_normalized SET ddi='99190' WHERE (LEFT(ddi,5)='99190');
UPDATE irda.irda_200806_normalized SET ddi='99191' WHERE (LEFT(ddi,5)='99191');
UPDATE irda.irda_200806_normalized SET ddi='99192' WHERE (LEFT(ddi,5)='99192');
UPDATE irda.irda_200806_normalized SET ddi='99193' WHERE (LEFT(ddi,5)='99193');
UPDATE irda.irda_200806_normalized SET ddi='99194' WHERE (LEFT(ddi,5)='99194');
UPDATE irda.irda_200806_normalized SET ddi='99195' WHERE (LEFT(ddi,5)='99195');
UPDATE irda.irda_200806_normalized SET ddi='99196' WHERE (LEFT(ddi,5)='99196');
UPDATE irda.irda_200806_normalized SET ddi='99197' WHERE (LEFT(ddi,5)='99197');



OPTIMIZE TABLE irda.irda_200806_normalized;
...
DROP TABLE IF EXISTS irda.irda_200806_askr;
CREATE TABLE irda.irda_200806_askr (KEY datum (datum), KEY ddi (ddi), KEY ani (ani)) SELECT * FROM irda.irda_200806 WHERE 1=0;
...
INSERT INTO irda.irda_200806_askr
 SELECT *
 FROM irda.irda_200806_normalized
...
UPDATE irda.irda_200806_askr SET ddi='99109' WHERE ddi='9910911';



OPTIMIZE TABLE irda.irda_200806_askr;
...
#SELECT ddi, COUNT(*) FROM irda.irda_200806_normalized GROUP BY ddi;
#SELECT ddi, COUNT(*) FROM irda.irda_200806_askr GROUP BY ddi;
