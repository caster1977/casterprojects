...
var
  ...
  mysql_error: function(_mysql: PMYSQL): pAnsiChar; stdcall;
  mysql_info: function(_mysql: PMYSQL): pAnsiChar; stdcall;
...
var
  ...
  {$IFDEF HAVE_OPENSSL}
  mysql_ssl_set: function(_mysql: PMYSQL; const key, cert, ca, capath: pAnsiChar): longint; stdcall;
  mysql_ssl_cipher: function(_mysql: PMYSQL): pAnsiChar; stdcall;
  ...
  mysql_stat: function(_mysql: PMYSQL): pAnsiChar; stdcall;
  mysql_get_server_info: function(_mysql: PMYSQL): pAnsiChar; stdcall;
  mysql_get_client_info: function: pAnsiChar; stdcall;
  mysql_get_host_info: function(_mysql: PMYSQL): pAnsiChar; stdcall;
  mysql_get_proto_info: function(_mysql: PMYSQL): longword; stdcall;
  mysql_list_dbs: function(_mysql: PMYSQL; const wild: pAnsiChar): PMYSQL_RES; stdcall;
  mysql_list_tables: function(_mysql: PMYSQL; const wild: pAnsiChar): PMYSQL_RES; stdcall;
  mysql_list_fields: function(_mysql: PMYSQL; const table, wild: pAnsiChar): PMYSQL_RES; stdcall;
