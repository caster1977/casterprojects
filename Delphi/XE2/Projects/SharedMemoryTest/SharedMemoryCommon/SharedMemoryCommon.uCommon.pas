unit SharedMemoryCommon.uCommon;
...
const
  ...
  WPARAM_CLIENT_SENDS_FILESIZE = 9;
  // клиент отправляет размер файла в байтах (LPARAM = размер символьного представления размера файла в байтах)
  WPARAM_SERVER_WANNA_DATA = 10;
  // сервер хочет указанный блок данных (LPARAM = порядковый номер запрашиваемого блока данных)
  WPARAM_CLIENT_SENDS_DATA = 11; // клиент отправляет указанный блок данных (LPARAM = размер переданных данных в байтах)
  WPARAM_SERVER_WANNA_CRC32 = 12;
  // сервер хочет контрольную сумму указанного блока данных (LPARAM = порядковый номер запрашиваемого блока данных)
