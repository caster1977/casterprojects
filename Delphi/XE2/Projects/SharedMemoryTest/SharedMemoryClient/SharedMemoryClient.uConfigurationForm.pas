...
begin
  ...
  MainForm.LogDebug(Format(TEXT_CHECKBOX_SWITCHED, [chkbxConfigurationFormCentered.Caption,
    CommonFunctions.GetConditionalString(b, TEXT_CHECKBOX_ON, TEXT_CHECKBOX_OFF)]));
end;
...
begin
  ...
  edbxMainFormLeftValue.Text := CommonFunctions.GetConditionalString(edbxMainFormLeftValue.Enabled,
    IntToStr(MainForm.Configuration.MainFormPosition.Left), '');
  edbxMainFormTopValue.Text := CommonFunctions.GetConditionalString(edbxMainFormTopValue.Enabled,
    IntToStr(MainForm.Configuration.MainFormPosition.Top), '');

  MainForm.LogDebug(Format(TEXT_CHECKBOX_SWITCHED, [chkbxMainFormCentered.Caption,
    CommonFunctions.GetConditionalString(bMainFormCentered, TEXT_CHECKBOX_ON, TEXT_CHECKBOX_OFF)]));
end;
...
begin
  ...
  edbxMainFormTopValue.Text := CommonFunctions.GetConditionalString(edbxMainFormTopValue.Enabled,
    IntToStr(MainForm.Configuration.MainFormPosition.Top), '');
  edbxMainFormWidthValue.Text := CommonFunctions.GetConditionalString(not bMainFormMaximized,
    IntToStr(MainForm.Configuration.MainFormPosition.Width), '');
  edbxMainFormHeightValue.Text := CommonFunctions.GetConditionalString(not bMainFormMaximized,
    IntToStr(MainForm.Configuration.MainFormPosition.Height), '');

  MainForm.LogDebug(Format(TEXT_CHECKBOX_SWITCHED, [chkbxMainFormCentered.Caption,
    CommonFunctions.GetConditionalString(bMainFormMaximized, TEXT_CHECKBOX_ON, TEXT_CHECKBOX_OFF)]));
end;
...
begin
  ...
  begin
    ...
    FormPosition.Centered := chkbxMainFormCentered.Enabled and chkbxMainFormCentered.Checked and
      (not(chkbxMainFormMaximized.Enabled and chkbxMainFormMaximized.Checked));
    ...
    FormPosition.Left := StrToIntDef(CommonFunctions.GetConditionalString(not FormPosition.Centered,
      Trim(edbxConfigurationFormLeftValue.Text), ''), CONST_DEFAULTVALUE_FORMPOSITION_LEFT);
    FormPosition.Top := StrToIntDef(CommonFunctions.GetConditionalString(not FormPosition.Centered,
      Trim(edbxConfigurationFormTopValue.Text), ''), CONST_DEFAULTVALUE_FORMPOSITION_TOP);
...
begin
  ...
  begin
    ...
    edbxMainFormLeftValue.Text := CommonFunctions.GetConditionalString
      (not(CONST_DEFAULTVALUE_MAINFORM_CENTERED or CONST_DEFAULTVALUE_MAINFORM_MAXIMIZED),
      IntToStr(CONST_DEFAULTVALUE_MAINFORM_LEFT), '');
    edbxMainFormTopValue.Text := CommonFunctions.GetConditionalString
      (not(CONST_DEFAULTVALUE_MAINFORM_CENTERED or CONST_DEFAULTVALUE_MAINFORM_MAXIMIZED),
      IntToStr(CONST_DEFAULTVALUE_MAINFORM_TOP), '');
    edbxMainFormWidthValue.Text := CommonFunctions.GetConditionalString(CONST_DEFAULTVALUE_MAINFORM_MAXIMIZED, '',
      IntToStr(CONST_DEFAULTVALUE_MAINFORM_WIDTH));
    edbxMainFormHeightValue.Text := CommonFunctions.GetConditionalString(CONST_DEFAULTVALUE_MAINFORM_MAXIMIZED, '',
      IntToStr(CONST_DEFAULTVALUE_MAINFORM_HEIGHT));

    chkbxConfigurationFormCentered.Checked := CONST_DEFAULTVALUE_FORMPOSITION_CENTERED;
    edbxConfigurationFormLeftValue.Text := CommonFunctions.GetConditionalString(CONST_DEFAULTVALUE_FORMPOSITION_CENTERED, '',
      IntToStr(CONST_DEFAULTVALUE_FORMPOSITION_LEFT));
    edbxConfigurationFormTopValue.Text := CommonFunctions.GetConditionalString(CONST_DEFAULTVALUE_FORMPOSITION_CENTERED, '',
      IntToStr(CONST_DEFAULTVALUE_FORMPOSITION_TOP));
...
begin
  ...
  MainForm.LogDebug(Format(TEXT_ACTION_SWITCHED, [Action_Help.Caption,
    CommonFunctions.GetConditionalString(Action_Help.Enabled, TEXT_ACTION_ON, TEXT_ACTION_OFF)]));
  ...
  begin
    ...
    edbxMainFormWidthValue.Text := CommonFunctions.GetConditionalString(MainForm.WindowState = wsMaximized, '',
      IntToStr(MainForm.Width));
    edbxMainFormHeightValue.Text := CommonFunctions.GetConditionalString(MainForm.WindowState = wsMaximized, '',
      IntToStr(MainForm.Height));

    chkbxConfigurationFormCentered.Checked := ConfigurationFormPosition.Centered;
    edbxConfigurationFormLeftValue.Text := CommonFunctions.GetConditionalString(ConfigurationFormPosition.Centered, '',
      IntToStr(ConfigurationFormPosition.Left));
    edbxConfigurationFormTopValue.Text := CommonFunctions.GetConditionalString(ConfigurationFormPosition.Centered, '',
