...
begin
  ProcedureHeader(Format(RsEventHandlerOfActionExecute, [actClose.Caption]),
    '{2BF0A9D9-668B-4004-B672-8F5E90E874DA}');
...
begin
  ProcedureHeader(Format(RsEventHandlerOfActionExecute, [actHelp.Caption]),
    '{AEBE97C7-DE36-498B-964A-0F15E903572F}');
...
begin
  ...
  begin
    ProcedureHeader(Format(RsEventHandlerOfActionUpdate, [actHelp.Caption]),
      '{14DF31FC-912A-49B3-9FB0-C713F5EDC2C5}');
    actHelp.Enabled := b;
...
begin
  ProcedureHeader(Format(RsEventHandlerOfFormCreation, [RsPhoneListForm]),
    '{DD0698E8-EC58-42A2-9178-3CEF2182E39D}');
