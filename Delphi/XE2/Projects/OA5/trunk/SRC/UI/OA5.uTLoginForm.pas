...
begin
  ProcedureHeader(Format(RsEventHandlerOfActionExecute, [actEnter.Caption]),
...
begin
  ProcedureHeader(Format(RsEventHandlerOfActionExecute, [actClose.Caption]),
    '{051B0A6E-B5FF-45D2-A88E-00E7883BADD8}');
...
begin
  ProcedureHeader(Format(RsEventHandlerOfActionExecute, [actHelp.Caption]),
    '{387AD513-3FC5-4D69-8DC9-C4841FFC2D22}');
...
begin
  ProcedureHeader(Format(RsEventHandlerOfFormCreation, [RsLoginForm]),
    '{B7B2C87E-2141-43CA-A41B-23FE0E874839}');
...
begin
  ProcedureHeader(Format(RsEventHandlerOfFormShowing, [RsLoginForm]),
    '{96321487-1DC9-4591-AD46-BD64CDC4B64D}');
