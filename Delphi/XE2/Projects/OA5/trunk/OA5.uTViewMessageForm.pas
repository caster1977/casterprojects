...
begin
  ProcedureHeader('Процедура перехода к следущему сообщению', '{CEC95D15-EAE9-4A73-850C-62F7230F1813}');
...
begin
  ProcedureHeader('Процедура перехода к предыдущему сообщению', '{493DAAC0-4DF7-479A-84AB-7E4D79758C31}');
