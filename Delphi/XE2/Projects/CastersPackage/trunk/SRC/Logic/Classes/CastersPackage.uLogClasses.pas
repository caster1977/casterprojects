                      ...
                      begin
                        Synchronize(
                          ...
                          begin
                            ...
                            XMLMessageDestination.Application.Handle := XMLMessageSource.Application.Handle;
                            XMLMessageDestination.Application.Filename := XMLMessageSource.Application.Filename;
                            XMLMessageDestination.Application.FilePath := XMLMessageSource.Application.FilePath;
                            XMLMessageDestination.Application.Form.Handle := XMLMessageSource.Application.Form.Handle;
                            XMLMessageDestination.Application.Form.Name := XMLMessageSource.Application.Form.Name;
                            XMLMessageDestination.Application.Method.Guid := XMLMessageSource.Application.Method.Guid;
                            XMLMessageDestination.Application.User := XMLMessageSource.Application.User;
