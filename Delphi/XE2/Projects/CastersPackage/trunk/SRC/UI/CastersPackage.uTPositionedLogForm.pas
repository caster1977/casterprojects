...
type
  ...
  public
    constructor Create(AOwner: TComponent; const ADialogPosition: TDialogPosition; ABusyCounter: PInteger = nil;
      ARefreshBusyStateMethod: TObjectMethod = nil; AProgressBar: TProgressBar = nil); reintroduce; virtual;
  published
...
constructor TPositionedLogForm.Create(AOwner: TComponent; const ADialogPosition: TDialogPosition;
  ABusyCounter: PInteger; ARefreshBusyStateMethod: TObjectMethod; AProgressBar: TProgressBar);
begin
