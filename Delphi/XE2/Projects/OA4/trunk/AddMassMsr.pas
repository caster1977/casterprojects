...
begin
  if MessageBox(Handle,PChar('Сгенерировано мероприятий: '+IntToStr(lvMsrDateTimeList.Items.Count)+'. Вы дествительно хотите их добавить?'),PChar('OA4 - Подтверждение добавления'),MB_OKCANCEL+MB_ICONQUESTION+MB_DEFBUTTON2)=IDOK then
    ModalResult:=mrOk;
end;
