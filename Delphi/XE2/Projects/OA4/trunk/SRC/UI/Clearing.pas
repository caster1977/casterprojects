              ...
              begin
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                      s := 'Получено некорректное количество номеров (' + IntToStr(k) +
                        ') телефонов принадлежащих мероприятию ID#' + slTemp[j] + '!';
                      bError := True;
                    end;
                  end
                  else
...
var
  b: boolean;
begin
  b := (chkbxClearingPhoneTable.Enabled and chkbxClearingPhoneTable.Checked) or
