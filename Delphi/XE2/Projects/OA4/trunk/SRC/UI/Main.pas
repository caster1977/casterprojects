...
uses Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms, Dialogs, ActnList, ComCtrls, StdCtrls, Buttons, ExtCtrls, AppEvnts, ToolWin, ActnMan, ActnCtrls, XPStyleActnCtrls, Menus, ImgList, ShellAPI, IniFiles, Spin,
  commctrl, XPMan, System.Actions, CastersPackage.uMysql, System.AnsiStrings;
...
uses About, Login, Options, Statistic, Users, Phones, CreateViewPost, ViewPostList, Registry, Grids, Maintenance, Clearing, // , RichEditTools
  StrUtils, AddMassMsr, MultiBuffer, System.UITypes;
