...
begin
  ...
  begin
    ...
    pm := mysql_real_connect(MySQLConnectionHandler, PAnsiChar(Configuration.sMySQLHost),
      PAnsiChar(Configuration.sMySQLUser), PAnsiChar(Configuration.sMySQLPassword), PAnsiChar(Configuration.sMySQLDatabase),
      Configuration.iMySQLPort, nil, 1);
  ...
  begin
    ...
    with TAboutForm.Create(Self) do
      try
        ...
        Label2.Caption := Format('Версия %d.%d Release %d Build %d', [gsFileVersionInfo1.ModuleVersion.Major,
