...
procedure TTrayIcon.SetTimeOut(const Value: LongWord);
begin
  if Value>30000 then
    FTimeOut:=30000
  else
...
begin
  ...
  case FBalloonStyle of
    bsNone:
      IconDataEx.dwInfoFlags:=NIIF_NONE;
    bsInfo:
      IconDataEx.dwInfoFlags:=NIIF_INFO;
    bsWarning:
      IconDataEx.dwInfoFlags:=NIIF_WARNING;
    bsError:
      IconDataEx.dwInfoFlags:=NIIF_ERROR;
  end;
