...
type
  ...
  private
    ...
    FOnBalloonClick: TNotifyEvent; // добавлено вручную
    FBalloonHint: string;
  ...
  public
    ...
    property OnBalloonClick: TNotifyEvent read FOnBalloonClick write FOnBalloonClick; // добавлено вручную
  ...
  published
    property OnBalloonClick; // добавлено вручную
    property Animate;
...
//    MessageBox(Application.Handle,'Возникла ошибка при вызове функции TrackMouseEvent(@t)',
//    'Внимание!',MB_OK+MB_ICONERROR+MB_DEFBUTTON1);
//            SendMessage(,WM_MOUSEHOVER,0,0)
//            SendMessage(,WM_MOUSELEAVE,0,0);
        ...
        NIN_BALLOONUSERCLICK: // добавлено вручную
        begin
