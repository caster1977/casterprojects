<?php
class model_warrantytypes extends model
{
  ...
  public function add_data($data = null)
  {
    ...
    if (isset($name))
    {
      ...
      $result = self::open("{call colex_upd_warrantytypes (?, ?, ?)}", array($id, $name, $active));
      try
      {
  ...
  public function delete_data($data = null)
  {
    ...
    if (isset($id))
    {
      $result = self::open("{call colex_del_warrantytypes (?)}", array($id));
      try
      {
