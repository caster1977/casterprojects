  ...
  <div class="col-sm-* col-xs-*">
    <form method="post" action="/modelparttypes">
      ...
      <div class="form-group-xs">
        ...
        <input type="text" class="form-control" id="name" name="name" maxlength="255" value="<?php htmlspecialchars(echo $row["name"]);?>" placeholder="Введите наименование" autofocus>
