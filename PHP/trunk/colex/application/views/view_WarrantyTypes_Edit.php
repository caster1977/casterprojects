  ...
  <div class="col-sm-* col-xs-*">
    <form method="post" action="/warrantytypes">
      ...
      <div class="form-group-xs">
        ...
        <textarea class="form-control" name="details" id="details" rows="20" cols="60" placeholder="Введите условия" required><?php echo htmlspecialchars($row["details"]);?></textarea>
      </div>
      <div class="checkbox">
