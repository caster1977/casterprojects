  ...
  <div class="col-sm-* col-xs-*">
    <form method="post" action="/dealershipagreements">
      ...
      <div class="form-group-xs">
        ...
        <textarea class="form-control" name="details" id="details" rows="20" cols="60" placeholder="Введите условия"><?php echo htmlspecialchars($row["details"]);? required></textarea>
      </div>
      <div class="checkbox">
