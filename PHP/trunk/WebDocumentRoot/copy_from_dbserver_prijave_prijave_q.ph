...
if (ftp_get($conn_id, "D:\\mysql\\data\\prijaves\\oldformat_prijave.ISD", "prijave.ISD", FTP_BINARY)) print "Файл 'prijave.ISD' успешно скопирован в файл 'oldformat_prijave.ISD'.\r\n"; else die("Не удалось скопировать файл 'prijave.ISD' в файл 'oldformat_prijave.ISD'.\r\n");
if (ftp_get($conn_id, "D:\\mysql\\data\\prijaves\\oldformat_prijave.ISM", "prijave.ISM", FTP_BINARY)) print "Файл 'prijave.ISM' успешно скопирован в файл 'oldformat_prijave.ISM'.\r\n"; else die("Не удалось скопировать файл 'prijave.ISM' в файл 'oldformat_prijave.ISM'.\r\n");
...
if (ftp_get($conn_id, "D:\\mysql\\data\\prijaves\\oldformat_prijave_q.ISD", "prijave_q.ISD", FTP_BINARY)) print "Файл 'prijave_q.ISD' успешно скопирован в файл 'oldformat_prijave_q.ISD'.\r\n"; else die("Не удалось скопировать файл 'prijave.ISD' в файл 'oldformat_prijave_q.ISD'.\r\n");
if (ftp_get($conn_id, "D:\\mysql\\data\\prijaves\\oldformat_prijave_q.ISM", "prijave_q.ISM", FTP_BINARY)) print "Файл 'prijave_q.ISM' успешно скопирован в файл 'oldformat_prijave_q.ISM'.\r\n"; else die("Не удалось скопировать файл 'prijave.ISM' в файл 'oldformat_prijave_q.ISM'.\r\n");
// расчёт прошлого дня
